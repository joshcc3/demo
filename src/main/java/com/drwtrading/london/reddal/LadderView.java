...
//                    exception.printStackTrace();
    ...
    private Long getLastTradeChangeOnDay(final MarketDataForSymbol m) {
        if (m.lastTrade == null) {
            return null;
        }
        if (m.settle == null) {
    ...
    private long getMidPrice(final MarketDataForSymbol m) {
    ...
    private String laserKey(final String name) {
