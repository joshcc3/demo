...
public class Main {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (null != fxConfig) {
            ...
            final IFuseBox<FXFuse> fxFuseBox = new ExpandedDetailResourceMonitor<>(monitor, "FX", errorLog, FXFuse.class, ReddalComponents.FX);
            final IFuseBox<SelectIOComponents> selectIOFuseBox = new ExpandedDetailResourceMonitor<>(fxFuseBox, name, errorLog, SelectIOComponents.class, FXFuse.FX_SELECT_IO);

            final SelectIO fxSelectIO = new SelectIO(selectIOFuseBox);

            final FXCalc<FXFuse> fxCalc = new FXCalc<>(fxSelectIO, fxFuseBox, FXFuse.FX_CALC, FXFuse.FX_TIMEOUT, fxConfig, Constants::NO_OP);
