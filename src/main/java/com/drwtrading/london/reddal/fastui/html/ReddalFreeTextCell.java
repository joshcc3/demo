...
public enum ReddalFreeTextCell {
    ...
    static {
        ...
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R1C5, R1C5);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R2C1, R2C1);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R2C2, R2C2);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R2C3, R2C3);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R2C4, R2C4);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R2C5, R2C5);
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R3C1, R3C1);
        ...
        FREETEXT_CELL_TO_REDDAL_FREETEXT_CELL_MAP.put(LadderTextCell.R3C5, R3C5);
