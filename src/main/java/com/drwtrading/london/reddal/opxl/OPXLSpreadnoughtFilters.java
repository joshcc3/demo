...
public class OPXLSpreadnoughtFilters extends AFiltersOPXL {
    ...
    public static final StackCommunity COMMUNITY = StackCommunity.SPREADNOUGHT;
    ...
    public OPXLSpreadnoughtFilters(final SelectIO opxlSelectIO, final SelectIO callbackSelectIO, final IFuseBox<OPXLComponents> monitor,
            final Path logPath, final StackFamilyPresenter stackFamilyPresenter) {
    ...
    protected void handleUpdate(final Collection<StackChildFilter> prevValue, final Collection<StackChildFilter> values) {
        ...
        stackFamilyPresenter.setFamiliesFilters(COMMUNITY, values);
    }
}
