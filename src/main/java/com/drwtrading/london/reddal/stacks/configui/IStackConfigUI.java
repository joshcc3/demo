...
public interface IStackConfigUI {
    ...
    public void setRow(final String nibblerName, final long configGroupID, final String symbol, final StackConfigType configType,
            ...
            final int bidMaxOrdersPerLevel, final boolean bidIsQuoteBettermentOn, final byte bidQuoteFlickerBufferPercent,
            ...
            final int askPlanLotSize, final int askPlanMaxLevels, final int askMaxOrdersPerLevel, final boolean askIsQuoteBettermentOn,
            final byte askQuoteFlickerBufferPercent, final int askQuotePicardMaxTicksThrough, final int askPicardMaxPerSec,
