...
public interface IStackConfigUI {
    ...
    public void setRow(final String nibblerName, final long configGroupID, final String symbol, final StackConfigType configType,
            ...
            final int quoteBettermentQty, final boolean quoteIsBettermentOppositeSide, final int quoteBettermentTicks,
            final int fxMaxBookAgeMillis, final int fxMaxJumpBPS, final int leanMaxBookAgeMillis, final int leanMaxJumpBPS,
            final int leanRequiredQty, final int leanMaxPapaWeight, final String leanToQuoteRatio, final double leanPriceAdjustmentRaw,
            ...
            final boolean bidIsQuoteBettermentOn, final int bidModTicks, final byte bidQuoteFlickerBufferPercent,
            final int bidQuotePicardMaxBPSThrough, final byte bidMaxPapaWeight, final int bidPicardMaxPerSec, final int bidPicardMaxPerMin,
            ...
            final byte askQuoteFlickerBufferPercent, final int askQuotePicardMaxBPSThrough, final byte askMaxPapaWeight,
