...
public interface IStackConfigUI {
    ...
    public void setRow(final String nibblerName, final long configGroupID, final String symbol, final StackConfigType configType,
            ...
            final String leanToQuoteRatio, final double leanPriceAdjustmentRaw, final boolean additiveIsEnabled,
            final long additiveMaxSignalAgeMillis, final int additiveMinRequiredBPS, final int additiveMaxBPS, final int bidPlanMinLevelQty,
