...
public interface IStackStrategiesUI {
    ...
    public void setRow(final String nibblerName, final long id, final String quoteSymbol, final String quoteISIN, final String quoteCCY, final String quoteMIC,
            final String leanInstType, final String leanSymbol, final String leanISIN, final String leanCCY, final String leanMIC,
